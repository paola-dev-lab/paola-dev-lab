...
- string_lab — bibliothèque de manipulation de chaînes en C
- text_analyzer — outil CLI d’analyse textuelle
- csvmini (en construction) — parsing et transformation de fichiers CSV
